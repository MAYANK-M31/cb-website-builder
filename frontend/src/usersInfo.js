...
var usersByName = (0, vue_1.reactive)({});
...
var triggerDebouncedFetch = (0, core_1.useDebounceFn)(processBatch, 50);
function processBatch() {
    return __awaiter(this, void 0, void 0, function () {
        var emailsToFetch, res_1, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    emailsToFetch = Array.from(queue);
                    if (emailsToFetch.length === 0)
                        return [2 /*return*/];
                    queue.clear();
                    emailsToFetch.forEach(function (email) { return activeRequests.add(email); });
                    _a.label = 1;
                case 1:
                ...
                case 2:
                    res_1 = (_a.sent());
                    emailsToFetch.forEach(function (email) {
                        if (res_1 && res_1[email]) {
                            Object.assign(usersByName[email], res_1[email]);
                        }
                    });
                    return [3 /*break*/, 5];
                case 3:
                    error_1 = _a.sent();
                    console.error("Failed to fetch users info", error_1);
                    return [3 /*break*/, 5];
                case 4:
                    emailsToFetch.forEach(function (email) {
